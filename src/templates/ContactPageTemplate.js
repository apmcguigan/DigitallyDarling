    ...
    <div className="mx-auto pb-12 text-beige bg-beige">
      <div className="relative h-full bg-darkGreen text-center py-12 lg:py-36 items-center">
        <div className="mx-16 sm:mx-32 md:mx-40 lg:mx-56 mt-6">
          <h1 className="font-nunito text-left text-beige text-5xl lg:text-7xl xs:pt-20 md:pt-28 lg:pt-36">
            LET'S{" "}
          </h1>
          <h1 className="font-volkorn text-left text-beige text-5xl lg:text-7xl pt-2 ml-6">
            CONNECT
          </h1>
      ...
      <div className="w-8/12 mx-auto text-darkGreen">
        <h1 className="mt-12 text-xl text-center">{contactform.heading}</h1>
        <h1 className="mt-2 text-xl text-center">
          If you're looking for a FREE 30-minute Discovery Call,{" "}
          <a href="https://portal.digitallydarling.ca/public/form/view/62ba586cd0569418718a9ed3">
            click here.
          </a>
        </h1>
        ...
        <div className="block lg:hidden pt-4">
          <h1 className="text-center pt-2">Email beth@digitallydarling.ca</h1>
          <h1 className="text-center pt-2">Facebook @digitallydarling</h1>
          <h1 className="text-center pt-2">Instagram @digitallydarling</h1>
        </div>
